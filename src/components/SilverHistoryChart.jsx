...
export default function SilverHistoryChart({ silverHistory }) {
    ...
    if (!silverHistory || !silverHistory.data || silverHistory.data.length === 0) {
        return null;
    }

    const history = silverHistory.data;
            ...
            <div className="brutal-card gold-history-card" style={{ borderColor: 'var(--silver-dark)' }}>
                <div className="card-header">
                    <div>
                        ...
                        <h3>SILVER PRICE HISTORY (30 DAYS)</h3>
                    </div>
                </div>
                        ...
                        >
                            <defs>
                                <linearGradient id="silverGradient" x1="0" y1="0" x2="0" y2="1">
                                    <stop offset="5%" stopColor="var(--silver-accent)" stopOpacity={0.7} />
                                    <stop offset="95%" stopColor="var(--silver-accent)" stopOpacity={0.1} />
                                </linearGradient>
                            </defs>
                ...
                {showTable && (
                    <div className="gold-table-container">
                        <table className="gold-price-table" style={{ borderColor: 'var(--silver-dark)' }}>
                            <thead>
                                <tr>
                                    <th>DATE</th>
                                    <th>PRICE (USD/oz)</th>
